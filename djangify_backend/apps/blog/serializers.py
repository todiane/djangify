...
class CategorySerializer(TimeStampedModelSerializer, SEOModelSerializer):
    class Meta:
        model = Category
        fields = ['id', 'name', 'slug', 'description'] + TimeStampedModelSerializer.Meta.fields + SEOModelSerializer.Meta.fields
...
class CommentSerializer(TimeStampedModelSerializer):
    class Meta:
        model = Comment
        fields = ['id', 'post', 'name', 'email', 'content', 'is_approved'] + TimeStampedModelSerializer.Meta.fields
...
class PostSerializer(TimeStampedModelSerializer, SEOModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'category', 'tags', 'status', 'published_date', 'is_featured', 
            'comments'
