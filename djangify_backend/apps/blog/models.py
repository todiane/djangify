...
class Post(TimeStampedModel, SluggedModel, SEOModel):
    ...
    def get_absolute_url(self):
        """
        Returns the full URL to the post based on your frontend URL structure.
        This is used in email templates and other places that need the full URL.
        """
        from django.conf import settings

        # The frontend URL structure for blog posts
        path = f"/blog/{self.slug}"

        # If FRONTEND_URL is set in settings, use it, otherwise use a default
